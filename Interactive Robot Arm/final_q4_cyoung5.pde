...
// Movements: Q/W rotate shoulder joint, A/S rotate shoulder twist, 
// T/Y rotate angle between upper and lower arm, G/H lower arm twist, O/P bend the last joint up and down
// Q/W rotates the joint, so it moves everything. A/S twists the upper arm
